...
router.post("/maintain",body('products').isArray().withMessage('must be an array').custom(checkIntArray), 
finalCheck,
receiveRequest)

router.post("/doneWarranty", 
...
body('done').optional({checkFalsy: null}).isBoolean().withMessage('must be true or false'),
finalCheck,
finishWaranty)

router.post('/sendBack', 
body('products').isArray().withMessage('must be an array').custom(checkIntArray), 
finalCheck,
sendBack);

router.post('/sendBackToFactory', 
body('products').isArray().withMessage('must be an array').custom(checkIntArray), 
finalCheck,
sendBackToFactory);
