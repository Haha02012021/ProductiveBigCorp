  ...
  try {
    ...
    await Engine.create({
      ...
      he_thong_ngung_khoi_dong_thong_minh:
        data.he_thong_ngung_khoi_dong_thong_minh,
    });
    await Exterior.create({
      ...
      den_truoc_tu_dong_can_bang_goc_chieu:
        data.den_truoc_tu_dong_can_bang_goc_chieu,
      guong_chieu_hau_ngoai_gap_dien_chinh_dien:
        data.guong_chieu_hau_ngoai_gap_dien_chinh_dien,
    ...
    await Interior.create({
      ...
      guong_hau_trung_tam_chong_choi_tu_dong:
        data.guong_hau_trung_tam_chong_choi_tu_dong,
      hud: data.hud,
      ...
      hang_ghe_thu_hai_gap_theo_ti_le_60_40:
        data.hang_ghe_thu_hai_gap_theo_ti_le_60_40,
    });
    ...
    await Safety.create({
      ...
      cam_bien_canh_bao_va_cham_phia_sau:
        data.cam_bien_canh_bao_va_cham_phia_sau,
      cam_bien_canh_bao_va_cham_phia_truoc:
        data.cam_bien_canh_bao_va_cham_phia_truoc,
...
const editVer = async (id, updateInfo) => {
  ...
  try {
    ...
    if (updateInfo.iactivsense) {
      await Iactivsense.update(updateInfo.iactivsense, {
        where: { version_id: id },
      });
    }
...
const getInfo = async (id) => {
  try {
    const versionInfo = await Version.findByPk(id, {
      include: [
        {
          model: Chassis,
          as: "chassis",
